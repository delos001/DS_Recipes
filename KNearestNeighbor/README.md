...
different from other model fitting functions that require 2 step: 1: fit model, 2: use model to make predictions
knn() performs predictions in single command based on 4 inputs:

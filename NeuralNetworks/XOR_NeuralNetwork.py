...
class Neuron:
    ...
    # yⱼ = φ = 1 / (1 + e^(-zⱼ))
    # Note that where ⱼ represents the output of the neurons in whatever layer we're 
    # looking at and ᵢ represents the layer below it
    #
    ...
    # The total net input is the weighted sum of all the inputs to the neuron and their 
    # respective weights:
    # = zⱼ = netⱼ = x₁w₁ + x₂w₂ ...
    #
...
for i in range(10000):
    ...
    print(i, 
          round(nn.calculate_total_error([[[0.05, 0.1], 
                                           [0.01, 0.99]]]), 
                9))

...
zHometab=pd.crosstab(index=dfcmpout['zHome_Ent'],columns='count', margins=True)
zMOtab=pd.crosstab(index=dfcmpout['zMO_Buyer'],columns='count', margins=True)
zCCtab=pd.crosstab(index=dfcmpout['zCC_Presence'],columns='count', margins=True)
zHItab=pd.crosstab(index=dfcmpout['zHi_Tech_Owner'],columns='count', 
            margins=True)
